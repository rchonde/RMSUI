    ...
    switch (routeName) {
      ...
      case "Master": {
        route = {
          ...
          isCollapsed: true,
          children: [
            { path: "Locationmaster", title: "Location Master", type: "link", ChildID: 0 },
          ]
        }
        break;
      }
      ...
      //  case "QC": {
      //   // route.children.push({ path: "file-upload", title: "File Upload", type: "link" })
      //   route = { path: "QC", title: "QC", type: "link" }
      //    break;
      //  }     

       case "Outward": {
        // route.children.push({ path: "file-upload", title: "File Upload", type: "link" })
        route = { path: "Outward", title: "Retrieval", type: "link" }
         break;
       }  
      //  case "Scanning": {
      //   // route.children.push({ path: "file-upload", title: "File Upload", type: "link" })
      //   route = { path: "Scanning", title: "Scanning", type: "link" }
      //    break;
      //  }     

       case "Refilling": {
        // route.children.push({ path: "file-upload", title: "File Upload", type: "link" })
        route = { path: "Refilling", title: "Refilling", type: "link" }
         break;
       }     
      ...
      case "Quicksearch":{
        route = { path: "Quicksearch", title: "Filter Search", type: "link" }
        break;
      }
      
      case "Retrieval":{
        route = { path: "Retrieval", title: "Retrieval", type: "link" }
        break;
      }
      case "RefillingFile":{
        route = { path: "RefillingFile", title: "Refilling File", type: "link" }
        break;
      }
      case "Approval":{
      ...
      case "Inwardreport":{
        route = { path: "Inwardreport", title: "Inward Report", type: "link" }
        break;
      }

      case "logs":{
        route = { path: "logs", title: "Logs Report", type: "link" }
        break;
      }
      case "Locationbarcode":{
        route = { path: "Locationbarcode", title: "Location Barcode Report", type: "link" }
        break;
      }
      ...
      // case "Uplaod Scanning Status": {
      // //  route.children.push({ path: "data-upload", title: "Data Upload", type: "link"})
      // route = { path: "data-upload", title: "Uplaod Scanning Status", type: "link" }
      //   break;
      // }
      case "inward-upload": {
        //  route.children.push({ path: "data-upload", title: "Data Upload", type: "link"})
        route = { path: "inward-upload", title: "Inward CSV Upload", type: "link" }
          break;
        }

        case "RetrivalInward": {
          //  route.children.push({ path: "data-upload", title: "Data Upload", type: "link"})
          route = { path: "RetrivalInward", title: "Retrieval Csv Upload", type: "link" }
            break;
          }
