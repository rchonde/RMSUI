  ...
  GetBarcodeData() {
    ...
    let  CaseNo = this.InwardForm.controls['CaseNo'].value;
     // let  __TempID = this.InwardForm.controls['TemplateID'].value;  
      const apiUrl=this._global.baseAPIUrl+'Inward/GetBarcodeData?CaseNo='+CaseNo+'&user_Token='+ localStorage.getItem('User_Token')+ '&status=DataEntry';
...
//         }
  ...
  GetInwardData() {     
    ...
    const apiUrl = this._global.baseAPIUrl + 'BranchMaster/GetBranchDetails?homeBannerID='+localStorage.getItem('UserID') + '&user_Token='+ localStorage.getItem('User_Token')+ '&status=DataEntry';
    this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
