...
//         }
  ...
  GetInwardData() {     
    ...
    const apiUrl = this._global.baseAPIUrl + 'BranchMaster/GetBranchDetails?homeBannerID='+localStorage.getItem('UserID') + '&user_Token='+ localStorage.getItem('User_Token')+ '&status=Scanning';
    this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
