...
@Component({
  selector: "app-RefillingFile",
  templateUrl: "RefillingFile.component.html",
  styleUrls : ["RefillingFile.component.css"]
})
export class RefillingFileComponent implements OnInit {
...
// _Replacestr:any="D:/WW/14-Jully-2020/UI/src/assets";
  ...
  GetIndexListPending() {     
    ...
    const apiUrl = this._global.baseAPIUrl + 'BranchMaster/GetReffiling?user_Token='+ localStorage.getItem('User_Token');
  ...
  onChangeTickets(e) {
    ...
    GetFilterSearch() {     
      ...
      const apiUrl = this._global.baseAPIUrl + 'Inward/SearchRecordsByRifiling?user_Token='+ localStorage.getItem('User_Token') +'&FileNo='+this.ContentSearchForm.get('FileNo').value+'&SearchBy='+this.ContentSearchForm.get('SearchBy').value;
      this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
      this._IndexPendingList = data;
      this._FilteredList = data
      ...
      this.rows = e.rows;
            ...
            prepareTableData(tableData, headerList) {
              ...
              //  { field: 'docType', header: 'Doc Type', index: 5 },
                ...
                { field: 'Outwarddate', header: 'RetrievalDate', index: 6 },
                { field: 'OutwardBy', header: 'RetrievalBy', index: 6 },
          ...
          //    console.log("tableData",tableData);
              tableData.forEach((el, index) => {
                formattedData.push({
                  ...
                  "Outwarddate": el.Outwarddate,
                  "OutwardBy": el.OutwardBy,                 
...
onSubmit() {
  ...
  validation()
  {
      ...
      {
               this.showmessage("Please Enter Carton No");
                return false;
      }
