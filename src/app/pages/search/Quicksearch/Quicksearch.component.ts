...
// _Replacestr:any="D:/WW/14-Jully-2020/UI/src/assets";
  ...
  ngOnInit(){
    ...
    this.InwardForm = this.formBuilder.group({     
      ...
      FileStatus: [0, Validators.required],
      FileAccesstype: [0, Validators.required],
      User_Token: localStorage.getItem('User_Token') ,
      CreatedBy: localStorage.getItem('UserID') ,
  ...
  GetIndexListPending() {     
    ...
    const apiUrl = this._global.baseAPIUrl + 'BranchMaster/GetFileStatus?user_Token='+ localStorage.getItem('User_Token');
  ...
  onChangeTickets(e) {
    ...
    GetFilterSearch() {     
      ...
      const apiUrl = this._global.baseAPIUrl + 'Inward/SearchRecords?user_Token='+ localStorage.getItem('User_Token') +'&FileNo='+this.ContentSearchForm.get('FileNo').value+'&SearchBy='+this.ContentSearchForm.get('SearchBy').value;
      this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
      this._IndexPendingList = data;
      this._FilteredList = data
      ...
      this.rows = e.rows;
            ...
            prepareTableData(tableData, headerList) {
              ...
              let tableHeader: any = [
               ...
               //  { field: 'ContactName', header: 'ContactName', index: 3 },
              ...
              //  { field: 'docType', header: 'Doc Type', index: 5 },
                ...
                // { field: 'ReFllingDate', header: 'ReFllingDate', index: 6 },
...
this.modalRef = this.modalService.show(template); 
 ...
 {
   this.showmessage("File is already :-" + row.Status);
 }
...
onSubmit() {
  ...
  const apiUrl = this._global.baseAPIUrl + 'Inward/RequestUdpate';
  ...
  Print(row:any)
{
   ...
   // const fileExt = _File.filePath.substring(_File.filePath.lastIndexOf('.'), _File.filePath.length);
    const apiUrl = this._global.baseAPIUrl + 'Inward/DownloadFile?RequestID='+row.RequestID +'&user_Token=' + localStorage.getItem('User_Token');
