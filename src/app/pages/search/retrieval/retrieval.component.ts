...
// _Replacestr:any="D:/WW/14-Jully-2020/UI/src/assets";
  ...
  GetIndexListPending() {     
    ...
    const apiUrl = this._global.baseAPIUrl + 'BranchMaster/GetRetrival?user_Token='+ localStorage.getItem('User_Token');
  ...
  get t() { return this.f.tickets as FormArray; }
    ...
    GetFilterSearch() {     
      ...
      const apiUrl = this._global.baseAPIUrl + 'Inward/SearchRecordsByRetrival?user_Token='+ localStorage.getItem('User_Token') +'&FileNo='+this.ContentSearchForm.get('FileNo').value+'&SearchBy='+this.ContentSearchForm.get('SearchBy').value;
      this._onlineExamService.getAllData(apiUrl).subscribe((data: {}) => {     
      this._IndexPendingList = data;
      this._FilteredList = data
      ...
      this.rows = e.rows;
            ...
            prepareTableData(tableData, headerList) {
              ...
              let tableHeader: any = [
                ...
                { field: 'DocumentNo', header: 'DocumentNo', index: 2 },                
