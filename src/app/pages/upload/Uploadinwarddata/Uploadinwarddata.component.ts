...
@Component({
  selector: "app-Uploadinwarddata",
  templateUrl: "Uploadinwarddata.component.html",
})
export class UploadinwarddataComponent implements OnInit {
entries: number = 10;
selected: any[] = [];
temp = [];
activeRow: any;
...
@Output() public onUploadFinished = new EventEmitter();
 ...
 //   console.log($event.target.value);
  ...
  getHeaderArray(csvRecordsArr: any) {
    var  headers;
    headers ="CartonNo,FileNo,DocumentNo,Ref1,Ref2,Ref3,Ref4,LocationBarcode";
    // let headerArray = [];
 ...
 if(this._CSVData != null && this._CSVData != undefined)
 {
    ...
    const apiUrl = this._global.baseAPIUrl + 'DataUpload/UploadInwardData';
...
//console.log(this._ColNameList);
  ...
  this._ColNameList[1] ="FileNo";
  this._ColNameList[2] ="DocumentNo";
    
    this._ColNameList[3] ="Ref1";
    this._ColNameList[4] ="Ref2";
    this._ColNameList[5] ="Ref3";
    this._ColNameList[6] ="Ref4";
    this._ColNameList[7] ="LocationBarcode";

    // for (let j = 0; j < headers.length; j++) {
    // //  if (headers[j] != this._ColNameList[j].DisplayName) {
  ...
  GetHeaderNames() {
    ...
    this._HeaderList ="CartonNo,FileNo,DocumentNo,Ref1,Ref2,Ref3,Ref4,LocationBarcode";
  ...
  downloadFile() {
    ...
    let csvData = "CartonNo,FileNo,DocumentNo,Ref1,Ref2,Ref3,Ref4,LocationBarcode";    
    //console.log(csvData)
