...
export class InwardreportComponent implements OnInit {
  ...
  _ColNameList = ["CartonNo", "FileNo","DocumentNo","RequestID","FileStatus","FileAccesstype","Status","InwardBy", "InwardDate","OutwardBy", "Outwarddate", "ReFllingDate", "RefillingBy", "ContactName", "EmailID"];
  ...
  getStatusList() {  
    ...
    const apiUrl = this._global.baseAPIUrl + 'Inward/GetInwardREport';          
  ...
  downloadFile() { 
    ...
    dwldLink.setAttribute("download",  "Inward Report" + ".csv"); 
