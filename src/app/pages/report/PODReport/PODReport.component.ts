...
@Component({
  ...
  templateUrl: "PODReport.component.html",
})
export class PODReportComponent implements OnInit {
  entries: number = 10;
  selected: any[] = [];
  temp = [];
  activeRow: any;
  ...
  _ColNameList = ["PODNO", "Courier","BranchName","TotalInvoicecount", "TotalReceivedInvoicecount", "DispatchDate", "PODReceivedDate","Status", "Remark"];
